...
import { needsInternalCatalog } from "../../data/needsInternalCatalog";
...
// Composant principal pour gérer le catalogue interne
const InternalCatalog = () => {
  ...
  } = useTable<InternalCatalogProps>(needsInternalCatalog, TABLE_HEADERS, TABLE_KEYS, RECORDS_PER_PAGE)
  ...
  const [formData, setFormData] = useState({
    axe: "", // Axe sélectionné par l'utilisateur
  });
  ...
  // Définition des colonnes avec des rendus personnalisés
  const renderers = {
    select: (_: string, row: InternalCatalogProps) => (
...
export default InternalCatalog;